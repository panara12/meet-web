...
const doc_cloudinary_upload = async(local_path,tenent_username,customFileName)=>{
    // console.log('localpath',local_path)
    // console.log('distributer name',tenent_username)
    try {
        const folder = `tenent_document/${tenent_username}`;
...
module.exports = {cloudinary_upload,doc_cloudinary_upload}